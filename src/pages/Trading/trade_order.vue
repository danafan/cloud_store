<template>
	...
	<el-table :data="dataObj.data" border style="width: 100%" :header-cell-style="{'background':'#f4f4f4'}">
		<el-table-column width="180" fixed prop="created_time" label="订单创建时间" align="center">
		</el-table-column>
		...
		<el-table-column width="180" prop="pay_money" label="商户打款金额（元）" align="center">
		</el-table-column>
		<el-table-column width="180" prop="service_charge" label="商户实收服务费（元）" align="center">
		</el-table-column>
		...
		<el-table-column width="220" fixed="right" label="操作" align="center">
			<template slot-scope="scope">
				...
				<el-button type="text" size="small" @click="getDetail(scope.row.order_id)" v-if="judgeDetail(scope.row) && (dataObj.is_supper == 1 || (dataObj.is_supper == 0 && dataObj.button_list.detail == 1))">详情</el-button>
			</template>
		</el-table-column>
	</el-table>
	<div class="page">
...
<script>
	...
	export default{
		...
		methods:{
			...
			//详情
			judgeDetail(item){
				if((item.order_status1 == 2 && item.order_status2 == 6) || item.order_status1 == 6 || item.order_status1 == 8){
					return true;
				}else{
					return false;
				}
